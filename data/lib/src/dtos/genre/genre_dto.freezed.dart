...
abstract class $GenreDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? title, String? input, String? script});
}
...
class _$_GenreDto implements _GenreDto {
  const _$_GenreDto({this.title, this.input, this.script});
  ...
  @override
  String toString() {
    return 'GenreDto(title: $title, input: $input, script: $script)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, input, script);
...
abstract class _GenreDto implements GenreDto {
  const factory _GenreDto(
      {final String? title,
      final String? input,
      final String? script}) = _$_GenreDto;
